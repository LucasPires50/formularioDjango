...
class PassagemForms(forms.ModelForm):
    ...
    class Meta:
        model = Passagem
        fields = '__all__'
        labels = {'data_ida':'Data de ida', 'data_volta': 'Data de volta', 'informacoes':'Informações', 'classe_viagem':'Classe da vôo' }
        widgets = {
            'data_ida':DatePicker(),
    ...
    #             messagem_erro = lista_de_erros[erro]
    #             self.add_error(erro, messagem_erro)
